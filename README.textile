...
There is also a "short Ogg video(Video and commentary on the basic features of sed_cleaner.)":http://txp-plugins.netcarving.com/file_download/121/sed_cleaner.basic.ogv about the basic features.
