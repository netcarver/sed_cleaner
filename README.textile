...
## Forms must follow the pattern: formname.type.*form* where _formname_ is the name the form is to have and _formtype_ is either _article_, _link_, _comment_, _file_ or _misc_.
